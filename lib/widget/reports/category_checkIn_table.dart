...
class CategoryCheckInTable extends StatelessWidget {
  final SessionController sessionController = Get.find();

  CategoryCheckInTable({Key? key}) : super(key: key);

  Future<List<CategoryCheckInCheckOutData>> _getCategoryCheckInData(
    String gate,
    String date,
  ) async {
    ...
    final categoryCheckInOutData = await reportsService.getCategoryCheckInData(
      token: token,
      gate: gate,
      date: date,
    );
    ...
    return Obx(
      () {
        ...
        return FutureBuilder<List<CategoryCheckInCheckOutData>>(
          future: _getCategoryCheckInData(gate, date),
          builder: _buildBody,
        );
      },
    );
